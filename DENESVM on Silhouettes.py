...
for layer in Des121.layers[:404]:
...
model_densenet.add(Dense(128, activation='relu'))
model_densenet.add(Dropout(0.5))
model_densenet.add(Dense(4, kernel_regularizer=tf.keras.regularizers.l1_l2(l1=0.01, l2=0.01), activation='softmax'))
...
plt.title('DeneSVM Model For Train and Valid Loss')
plt.subplot(1, 2, 2)
...
plt.title('DeneSVM Model For Train and Valid Accuracy')
plt.show()
...
plt.title('DeneSVM Model Training and validation Loss')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
plt.show()
...
plt.title('DeneSVM Model Training and validation Accuracy')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
plt.show()
...
def plot_confusion_matrix(cm, classes, normalize=True, title='DeneSVM Model Confusion matrix', cmap=plt.cm.Purples):
...
print('DeneSVM Model Confusion Matrix')
cm = confusion_matrix(y_test_c, Y_pred)
plot_confusion_matrix(cm, target_names, normalize=False, title='DeneSVM Model Confusion Matrix')
...
plt.title('ROC curve for DeneSVM')
...
plt.legend(loc="best")
plt.title("Precision vs Recall curve for DeneSVM")
plt.show()
