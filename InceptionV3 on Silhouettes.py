...
Des121 = tf.keras.applications.InceptionV3(input_shape=(150,150,3),include_top=False,weights="imagenet")
...
plt.title('InceptionV3 Model For Train and Valid Loss')
plt.subplot(1, 2, 2)
...
plt.title('InceptionV3 Model For Train and Valid Accuracy')
plt.show()
...
def plot_confusion_matrix(cm, classes, normalize=True, title='InceptionV3 Model Confusion matrix', cmap=plt.cm.Purples):
...
print('InceptionV3 Model Confusion Matrix')
cm = confusion_matrix(y_test_c, Y_pred)
plot_confusion_matrix(cm, target_names, normalize=False, title='InceptionV3 Model Confusion Matrix')
...
plt.legend(loc="best")
plt.title("Precision vs Recall curve for InceptionV3")
plt.show()
