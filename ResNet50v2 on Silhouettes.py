...
Des121 = tf.keras.applications.ResNet50V2(input_shape=(150,150,3),include_top=False,weights="imagenet")
...
plt.title('ResNet50V2 Model For Train and Valid Loss')
plt.subplot(1, 2, 2)
...
plt.title('ResNet50V2 Model For Train and Valid Accuracy')
plt.show()
...
plt.title('ResNet50V2 Model Training and validation Loss')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
plt.show()
...
plt.title('ResNet50V2 Model Training and validation Accuracy')
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.legend()
plt.show()
...
def plot_confusion_matrix(cm, classes, normalize=True, title='ResNet50V2 Model Confusion matrix', cmap=plt.cm.Purples):
...
print('ResNet50V2 Model Confusion Matrix')
cm = confusion_matrix(y_test_c, Y_pred)
plot_confusion_matrix(cm, target_names, normalize=False, title='ResNet50V2 Model Confusion Matrix')
...
plt.title('ROC curve for ResNet50V2')
...
plt.legend(loc="best")
plt.title("Precision vs Recall curve for ResNet50V2")
plt.show()
